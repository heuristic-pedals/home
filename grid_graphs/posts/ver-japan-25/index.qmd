...
@fig-fastest-sectors). This accolade was however shared between both the McLaren
drivers, which is a first sign that Verstappen was the more consistent driver
in Q3 - an impressive achievement given that [a McLaren topped every practice
session plus Q1 and Q2][f1-suzuka-2025-results]!
